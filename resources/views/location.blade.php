    ...
    <div style="font-family: 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; background: linear-gradient(135deg, #f8f9fa 0%, #ffffff 100%);">
        ...
        <section class="hero-section" style="padding: 120px 10% 80px 10%; text-align: center; position: relative; overflow: hidden;">
            ...
            <div style="position: relative; z-index: 2;">
                ...
                <h1 class="hero-title" style="font-size: 64px; color: #363558; margin: 0 0 25px 0; font-weight: 800; letter-spacing: -1.5px;">
                    Where We <span style="color: #DD3134;">Work</span>
                </h1>

                <p class="hero-subtitle" style="font-size: 20px; color: #5a5a5a; max-width: 800px; margin: 0 auto; line-height: 1.7;">
        ...
        <section class="stats-section" style="padding: 80px 10%; background: linear-gradient(135deg, #363558 0%, #434961 100%); color: white; position: relative;">
            ...
            <div style="position: relative; z-index: 2; max-width: 1200px; margin: 0 auto;">
                <div class="stats-grid" style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 40px; text-align: center;">
                    ...
                    <div class="stat-card" style="background: rgba(255,255,255,0.05); border-radius: 25px; padding: 40px 20px; backdrop-filter: blur(10px); border: 1px solid rgba(255,255,255,0.1);">
                        <div style="font-size: 48px; font-weight: 800; margin-bottom: 10px; color: #DD3134; display: flex; align-items: center; justify-content: center; gap: 10px;">
                            24 <span style="font-size: 24px; opacity: 0.7;"><i class="bi bi-geo-alt"></i></span>
                        </div>
                    ...
                    <div class="stat-card" style="background: rgba(255,255,255,0.05); border-radius: 25px; padding: 40px 20px; backdrop-filter: blur(10px); border: 1px solid rgba(255,255,255,0.1);">
                        <div style="font-size: 48px; font-weight: 800; margin-bottom: 10px; color: #46DE48; display: flex; align-items: center; justify-content: center; gap: 10px;">
                            4 <span style="font-size: 24px; opacity: 0.7;"><i class="bi bi-map"></i></span>
                        </div>
                    ...
                    <div class="stat-card" style="background: rgba(255,255,255,0.05); border-radius: 25px; padding: 40px 20px; backdrop-filter: blur(10px); border: 1px solid rgba(255,255,255,0.1);">
                        <div style="font-size: 48px; font-weight: 800; margin-bottom: 10px; color: #91746E; display: flex; align-items: center; justify-content: center; gap: 10px;">
                            472+ <span style="font-size: 24px; opacity: 0.7;"><i class="bi bi-people"></i></span>
                        </div>
                    ...
                    <div class="stat-card" style="background: rgba(255,255,255,0.05); border-radius: 25px; padding: 40px 20px; backdrop-filter: blur(10px); border: 1px solid rgba(255,255,255,0.1);">
                        <div style="font-size: 48px; font-weight: 800; margin-bottom: 10px; color: #808FBD; display: flex; align-items: center; justify-content: center; gap: 10px;">
                            13,460+ <span style="font-size: 24px; opacity: 0.7;"><i class="bi bi-balloon-heart"></i></span>
                        </div>
        ...
        <section class="regions-section" style="padding: 80px 10%; background: white; position: relative;">
            ...
            <div style="position: relative; z-index: 2; max-width: 1200px; margin: 0 auto;">
                ...
                <div class="regions-grid" style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 30px;">
                    <div style="background: white; border-radius: 25px; overflow: hidden; box-shadow: 0 25px 50px rgba(0,0,0,0.08); border: 1px solid #f0f0f0;">
                        <div style="background: linear-gradient(135deg, #DD3134, #FF6B6B); color: white; padding: 25px; display: flex; justify-content: space-between; align-items: center;">
                            <div>
                    ...
                    <div style="background: white; border-radius: 25px; overflow: hidden; box-shadow: 0 25px 50px rgba(0,0,0,0.08); border: 1px solid #f0f0f0;">
                        <div style="background: linear-gradient(135deg, #46DE48, #80E681); color: white; padding: 25px; display: flex; justify-content: space-between; align-items: center;">
                            <div><span style="font-weight: 800; font-size: 20px;">Eastern Region</span><div style="font-size: 13px; opacity: 0.9; margin-top: 5px;">5 districts</div></div>
                        ...
                        <div style="padding: 30px;">
                            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 25px;">
                                <div style="text-align: center;"><div style="font-size: 32px; font-weight: 800; color: #46DE48; margin-bottom: 5px;">86</div><div style="font-size: 12px; color: #808FBD; font-weight: 600;">Navigators</div></div>
                                <div style="text-align: center;"><div style="font-size: 32px; font-weight: 800; color: #46DE48; margin-bottom: 5px;">2,500</div><div style="font-size: 12px; color: #808FBD; font-weight: 600;">Mothers</div></div>
                            </div>
                             <div style="border-top: 1px solid #f0f0f0; padding-top: 20px;">
                                <div style="font-size: 14px; color: #363558; font-weight: 600; margin-bottom: 15px;">Key Districts</div>
                                <div style="display: flex; flex-wrap: wrap; gap: 10px;"><span style="font-size: 12px; background: rgba(70,222,72,0.1); color: #46DE48; padding: 6px 12px; border-radius: 15px; font-weight: 600;">Jinja</span><span style="font-size: 12px; background: rgba(70,222,72,0.1); color: #46DE48; padding: 6px 12px; border-radius: 15px; font-weight: 600;">+2 more</span></div>
                            </div>
                        </div>
                    </div>

                    <div style="background: white; border-radius: 25px; overflow: hidden; box-shadow: 0 25px 50px rgba(0,0,0,0.08); border: 1px solid #f0f0f0;">
                        <div style="background: linear-gradient(135deg, #91746E, #DCCEC1); color: white; padding: 25px; display: flex; justify-content: space-between; align-items: center;">
                            <div><span style="font-weight: 800; font-size: 20px;">Northern Region</span><div style="font-size: 13px; opacity: 0.9; margin-top: 5px;">6 districts</div></div>
                            <div style="background: rgba(255,255,255,0.2); width: 50px; height: 50px; border-radius: 12px; display: flex; align-items: center; justify-content: center; font-size: 24px; backdrop-filter: blur(10px);"><i class="bi bi-geo-alt"></i></div>
                        </div>
                        <div style="padding: 30px;">
                            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 25px;">
                                <div style="text-align: center;"><div style="font-size: 32px; font-weight: 800; color: #91746E; margin-bottom: 5px;">111</div><div style="font-size: 12px; color: #808FBD; font-weight: 600;">Navigators</div></div>
                                <div style="text-align: center;"><div style="font-size: 32px; font-weight: 800; color: #91746E; margin-bottom: 5px;">3,220</div><div style="font-size: 12px; color: #808FBD; font-weight: 600;">Mothers</div></div>
                            </div>
                            <div style="border-top: 1px solid #f0f0f0; padding-top: 20px;">
                                <div style="font-size: 14px; color: #363558; font-weight: 600; margin-bottom: 15px;">Key Districts</div>
                                <div style="display: flex; flex-wrap: wrap; gap: 10px;"><span style="font-size: 12px; background: rgba(145,116,110,0.1); color: #91746E; padding: 6px 12px; border-radius: 15px; font-weight: 600;">Gulu</span><span style="font-size: 12px; background: rgba(145,116,110,0.1); color: #91746E; padding: 6px 12px; border-radius: 15px; font-weight: 600;">+3 more</span></div>
                            </div>
                        </div>
                    </div>

                    <div style="background: white; border-radius: 25px; overflow: hidden; box-shadow: 0 25px 50px rgba(0,0,0,0.08); border: 1px solid #f0f0f0;">
                        <div style="background: linear-gradient(135deg, #808FBD, #A3B4E0); color: white; padding: 25px; display: flex; justify-content: space-between; align-items: center;">
                            <div><span style="font-weight: 800; font-size: 20px;">Western Region</span><div style="font-size: 13px; opacity: 0.9; margin-top: 5px;">6 districts</div></div>
                            <div style="background: rgba(255,255,255,0.2); width: 50px; height: 50px; border-radius: 12px; display: flex; align-items: center; justify-content: center; font-size: 24px; backdrop-filter: blur(10px);"><i class="bi bi-geo-alt"></i></div>
                        </div>
                        <div style="padding: 30px;">
                            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 25px;">
                                <div style="text-align: center;"><div style="font-size: 32px; font-weight: 800; color: #808FBD; margin-bottom: 5px;">100</div><div style="font-size: 12px; color: #808FBD; font-weight: 600;">Navigators</div></div>
                                <div style="text-align: center;"><div style="font-size: 32px; font-weight: 800; color: #808FBD; margin-bottom: 5px;">2,860</div><div style="font-size: 12px; color: #808FBD; font-weight: 600;">Mothers</div></div>
                            </div>
                            <div style="border-top: 1px solid #f0f0f0; padding-top: 20px;">
                                <div style="font-size: 14px; color: #363558; font-weight: 600; margin-bottom: 15px;">Key Districts</div>
                                <div style="display: flex; flex-wrap: wrap; gap: 10px;"><span style="font-size: 12px; background: rgba(128,143,189,0.1); color: #808FBD; padding: 6px 12px; border-radius: 15px; font-weight: 600;">Mbarara</span><span style="font-size: 12px; background: rgba(128,143,189,0.1); color: #808FBD; padding: 6px 12px; border-radius: 15px; font-weight: 600;">+3 more</span></div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="expansion-section" style="padding: 100px 10%; background: linear-gradient(135deg, #f0f2f5 0%, #ffffff 100%); text-align: center; position: relative;">
            ...
            <div style="position: relative; z-index: 2; max-width: 1000px; margin: 0 auto;">
                ...
                <h2 class="expansion-title" style="font-size: 48px; color: #363558; margin-bottom: 20px; font-weight: 800;">Expanding Our <span style="color: #46DE48;">National Reach</span></h2>
                <p style="color: #5a5a5a; max-width: 700px; margin: 0 auto 60px auto; line-height: 1.7; font-size: 18px;">By 2025, we aim to extend our life-saving services to all 135 districts in Uganda.</p>

                <div class="goals-container" style="display: flex; justify-content: center; gap: 40px; margin-bottom: 60px; flex-wrap: wrap;">
                    <div class="goal-card" style="background: white; padding: 40px 50px; border-radius: 25px; box-shadow: 0 20px 40px rgba(0,0,0,0.08); text-align: center; border-top: 6px solid #DD3134;">
                    ...
                    <div class="goal-card" style="background: white; padding: 40px 50px; border-radius: 25px; box-shadow: 0 20px 40px rgba(0,0,0,0.08); text-align: center; border-top: 6px solid #46DE48;">
                    ...
                    <div class="goal-card" style="background: white; padding: 40px 50px; border-radius: 25px; box-shadow: 0 20px 40px rgba(0,0,0,0.08); text-align: center; border-top: 6px solid #808FBD;">
