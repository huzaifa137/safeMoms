    ...
    <section style="padding: clamp(60px, 8vw, 100px) 5%; background: #FFF; position: relative;">
      ...
      <div style="position: relative; z-index: 2; max-width: 1400px; margin: 0 auto;">
        <div style="text-align: center; margin-bottom: clamp(40px, 6vw, 80px); padding: 0 20px;">
          <div
            style="display: inline-block; padding: 10px clamp(20px, 3vw, 30px); background: rgba(216,49,55,0.1); color: #363558; border-radius: 30px; font-size: clamp(12px, 1.5vw, 14px); font-weight: 700; margin-bottom: 25px; border: 1px solid rgba(216,49,55,0.2);">
            LEADERSHIP TEAM
          </div>
          <h3 style="font-size: clamp(32px, 4vw, 48px); color: #363558; margin-bottom: 25px; font-weight: 800;">Our Leadership</h3>
        ...
        <div class="leadership-grid">
          ...
          <div class="leader-card"
            style="animation: fadeSlideUp 0.7s ease; animation-delay: 0.1s; animation-fill-mode: both;">
            <div class="leader-image-container">
              <img src="{{ asset('assets/images/president.jpg') }}" class="leader-image" alt="Isiko Isaac">
              <div class="leader-badge" style="background: #D83137;">ED</div>
              <div class="leader-tag" style="background: #D83137;">FOUNDER</div>
            </div>
            <div class="leader-content">
              <h4 style="margin: 15px 0 5px 0; color: #363558; font-size: 22px; font-weight: 800;">Isiko Isaac</h4>
              <div style="color: #D83137; font-size: 15px; font-weight: 700; margin-bottom: 15px;">Executive Director &
                Co-Founder</div>
              <p style="font-size: 14px; color: #5a5a5a; line-height: 1.6; margin-bottom: 20px;">
                Founder of SafeMom Navigator, public health practitioner, and youth empowerment advocate. Leads strategic
                direction and partnerships.
              </p>
              <div
                style="font-size: 13px; color: #363558; font-weight: 600; border-top: 1px solid #f0f0f0; padding-top: 15px;">
                <span style="color: #D83137;">10+</span> Years Experience
              </div>
            </div>
          </div>
          ...
          <div class="leader-card"
            style="animation: fadeSlideUp 0.7s ease; animation-delay: 0.2s; animation-fill-mode: both;">
            <div class="leader-image-container">
            ...
            <div class="leader-content">
              <h4 style="margin: 15px 0 5px 0; color: #363558; font-size: 22px; font-weight: 800;">Mr Tobiloba Oyejide
                Alex Omotosho</h4>
              <div style="color: #46DE48; font-size: 15px; font-weight: 700; margin-bottom: 15px;">Director Research and
                Innovation</div>
              <p style="font-size: 14px; color: #5a5a5a; line-height: 1.6; margin-bottom: 20px;">
                BSc in Nursing, MSc in Community Health Nursing. Registered nurse and lecturer, pursuing PhD in Nursing at
                UBC.
              </p>
              <div
                style="font-size: 13px; color: #363558; font-weight: 600; border-top: 1px solid #f0f0f0; padding-top: 15px;">
          ...
          <div class="leader-card"
            style="animation: fadeSlideUp 0.7s ease; animation-delay: 0.3s; animation-fill-mode: both;">
            <div class="leader-image-container">
              <img src="{{ asset('assets/images/woman.jpg') }}" class="leader-image" alt="Dr Mirembe Christine Sabano">
              <div class="leader-badge" style="background: #363558;">MD</div>
              <div class="leader-tag" style="background: #363558;">PROGRAMS</div>
            </div>
            <div class="leader-content">
              <h4 style="margin: 15px 0 5px 0; color: #363558; font-size: 22px; font-weight: 800;">Dr Mirembe Christine
                Sabano</h4>
              <div style="color: #363558; font-size: 15px; font-weight: 700; margin-bottom: 15px;">Programs Director</div>
              <p style="font-size: 14px; color: #5a5a5a; line-height: 1.6; margin-bottom: 20px;">
                Medical doctor from Uganda Christian University. Leads maternal and child health initiatives, navigator
                training, and community engagement.
              </p>
              <div
                style="font-size: 13px; color: #363558; font-weight: 600; border-top: 1px solid #f0f0f0; padding-top: 15px;">
                <span style="color: #363558;">MBChB</span>
              </div>
            </div>
          </div>
          ...
          <div class="leader-card"
            style="animation: fadeSlideUp 0.7s ease; animation-delay: 0.4s; animation-fill-mode: both;">
            <div class="leader-image-container">
              <img src="{{ asset('assets/images/man.jpg') }}" class="leader-image" alt="Mr Bukenya Huzaifah">
              <div class="leader-badge" style="background: #D83137;">DH</div>
              <div class="leader-tag" style="background: #D83137;">DIGITAL</div>
            </div>
            <div class="leader-content">
              <h4 style="margin: 15px 0 5px 0; color: #363558; font-size: 22px; font-weight: 800;">Mr Bukenya Huzaifah
              </h4>
              <div style="color: #D83137; font-size: 15px; font-weight: 700; margin-bottom: 15px;">Digital Health Lead
              </div>
              <p style="font-size: 14px; color: #5a5a5a; line-height: 1.6; margin-bottom: 20px;">
                Oversees the SafeMoms Navigator digital platform, managing data systems, technology integration, and
                digital solutions.
              </p>
              <div
                style="font-size: 13px; color: #363558; font-weight: 600; border-top: 1px solid #f0f0f0; padding-top: 15px;">
                <span style="color: #D83137;">Tech Innovation</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="leadership-grid-second" style="justify-content: center; max-width: 1100px; margin: 0 auto;">
          ...
          <div class="leader-card"
            style="animation: fadeSlideUp 0.7s ease; animation-delay: 0.5s; animation-fill-mode: both;">
            <div class="leader-image-container">
              <img src="{{ asset('assets/images/woman.jpg') }}" class="leader-image" alt="Nakatabira Rebecca">
              <div class="leader-badge" style="background: #46DE48;">CE</div>
              <div class="leader-tag" style="background: #46DE48;">COMMUNITY</div>
            </div>
            <div class="leader-content">
              <h4 style="margin: 15px 0 5px 0; color: #363558; font-size: 22px; font-weight: 800;">Nakatabira Rebecca</h4>
              <div style="color: #46DE48; font-size: 15px; font-weight: 700; margin-bottom: 15px;">Community Engagement
                Coordinator</div>
              <p style="font-size: 14px; color: #5a5a5a; line-height: 1.6; margin-bottom: 20px;">
                Leads community outreach and health education initiatives in remote areas. Builds partnerships with local
                leaders and advocates for culturally sensitive interventions.
              </p>
              <div
                style="font-size: 13px; color: #363558; font-weight: 600; border-top: 1px solid #f0f0f0; padding-top: 15px;">
                <span style="color: #46DE48;">Midwifery Expert</span>
              </div>
            </div>
          </div>
          ...
          <div class="leader-card"
            style="animation: fadeSlideUp 0.7s ease; animation-delay: 0.6s; animation-fill-mode: both;">
            <div class="leader-image-container">
              <img src="{{ asset('assets/images/man.jpg') }}" class="leader-image" alt="Mr Isiko Jonathan Emmanuel">
              <div class="leader-badge" style="background: #363558;">OD</div>
              <div class="leader-tag" style="background: #363558;">OPERATIONS</div>
            </div>
            <div class="leader-content">
              <h4 style="margin: 15px 0 5px 0; color: #363558; font-size: 22px; font-weight: 800;">Mr Isiko Jonathan
                Emmanuel</h4>
              <div style="color: #363558; font-size: 15px; font-weight: 700; margin-bottom: 15px;">Operations Director
              </div>
              <p style="font-size: 14px; color: #5a5a5a; line-height: 1.6; margin-bottom: 20px;">
                Leads community mobilisation efforts, coordinates mother support groups, and develops local partnerships
                to strengthen maternal health services.
              </p>
              <div
                style="font-size: 13px; color: #363558; font-weight: 600; border-top: 1px solid #f0f0f0; padding-top: 15px;">
                <span style="color: #363558;">Community Mobilization</span>
              </div>
            </div>
          </div>
          ...
          <div class="leader-card"
            style="animation: fadeSlideUp 0.7s ease; animation-delay: 0.7s; animation-fill-mode: both;">
            <div class="leader-image-container">
              <img src="{{ asset('assets/images/woman.jpg') }}" class="leader-image" alt="Ms Okoro Irene">
              <div class="leader-badge" style="background: #D83137;">PM</div>
              <div class="leader-tag" style="background: #D83137;">PARTNERSHIPS</div>
            </div>
            <div class="leader-content">
              <h4 style="margin: 15px 0 5px 0; color: #363558; font-size: 22px; font-weight: 800;">Ms Okoro Irene</h4>
              <div style="color: #D83137; font-size: 15px; font-weight: 700; margin-bottom: 15px;">Partnership Manager
              </div>
              <p style="font-size: 14px; color: #5a5a5a; line-height: 1.6; margin-bottom: 20px;">
                Builds and manages strategic partnerships with organisations, stakeholders, and community groups to
                support maternal health programs.
              </p>
              <div
                style="font-size: 13px; color: #363558; font-weight: 600; border-top: 1px solid #f0f0f0; padding-top: 15px;">
                <span style="color: #D83137;">Strategic Partnerships</span>
              </div>
            </div>
          </div>
        </div>
