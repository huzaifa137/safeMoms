...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="/dash/assets/vendors/jvectormap/jquery-jvectormap.css">
    <link rel="stylesheet" href="/dash/assets/vendors/flag-icon-css/css/flag-icon.min.css">
    <link rel="stylesheet" href="/dash/assets/vendors/owl-carousel-2/owl.carousel.min.css">
    <link rel="stylesheet" href="/dash/assets/vendors/owl-carousel-2/owl.theme.default.min.css">
            ...
            <div class="profile-desc">
              <div class="profile-pic">
                <div class="count-indicator">
                  <img class="img-xs rounded-circle " src="/dash/assets/images/faces/face15.jpg" alt="">
              ...
              <div class="dropdown-menu dropdown-menu-right sidebar-dropdown preview-list" aria-labelledby="profile-dropdown">
                ...
                <a href="flush" class="dropdown-item preview-item">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link" id="profileDropdown" href="#" data-bs-toggle="dropdown">
                  <div class="navbar-profile">
                    <img class="img-xs rounded-circle" src="/dash/assets/images/faces/face15.jpg" alt="">
                    <p class="mb-0 d-none d-sm-block navbar-profile-name">Adminstrator</p>
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="profileDropdown">
                  ...
                  <div class="dropdown-divider"></div>
                  <a class="dropdown-item preview-item" href="flush">
                    <div class="preview-thumbnail">
                      <div class="preview-icon bg-dark rounded-circle">
                        <i class="mdi mdi-logout text-danger"></i>
                      </div>
...
<script src="/dash/assets/vendors/progressbar.js/progressbar.min.js"></script>
<script src="/dash/assets/vendors/jvectormap/jquery-jvectormap.min.js"></script>
<script src="/dash/assets/vendors/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
<script src="/dash/assets/vendors/owl-carousel-2/owl.carousel.min.js"></script>
<script src="/dash/assets/js/jquery.cookie.js" type="text/javascript"></script>
