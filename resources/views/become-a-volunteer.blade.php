        ...
        <div style="position: relative; z-index: 2; max-width: 1400px; margin: 0 auto;">
            ...
            <div class="animate-on-load"
                ...
                <div
                    ...
                    <div>
                        <div class="stat-number"
                            style="font-size: 48px; font-weight: 800; color: #DD3134; margin-bottom: 10px;">98%</div>
                        <div style="font-size: 16px; color: #DCCEC1; font-weight: 600;">Satisfaction Rate</div>
                    </div>
                    <div>
                        <div class="stat-number"
                            style="font-size: 48px; font-weight: 800; color: #91746E; margin-bottom: 10px;">40+</div>
            ...
            <div id="opportunities" style="margin-bottom: 100px;">
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 30px;">
                    ...
                    <div class="opportunity-card animate-on-load"
                        style="background: white; border-radius: 25px; overflow: hidden; box-shadow: 0 15px 40px rgba(0,0,0,0.08); position: relative; border-top: 5px solid #DD3134; animation-delay: 0.1s;">
                        <div style="padding: 35px 30px;">
                            ...
                            <div style="display: flex; flex-wrap: wrap; gap: 10px; margin-bottom: 30px;">
                                <span
                                    style="background: rgba(221,49,52,0.1); color: #DD3134; padding: 6px 15px; border-radius: 20px; font-size: 13px; font-weight: 600; transition: all 0.3s ease;">Public
                                    Speaking</span>
                                <span
                                    ...
                                    Engagement</span>
                                <span
                                    style="background: rgba(128,143,189,0.1); color: #373358; padding: 6px 15px; border-radius: 20px; font-size: 13px; font-weight: 600; transition: all 0.3s ease;">Local
                                    Languages</span>
                            </div>
                            <a href="#application2" style="text-decoration: none;"> <button
                                    style="background: linear-gradient(90deg, #DD3134, #FF6B6B); color: white; border: none; padding: 14px 30px; border-radius: 10px; font-size: 15px; font-weight: 700; cursor: pointer; width: 100%; display: flex; align-items: center; justify-content: center; gap: 10px; transition: all 0.3s ease;">
                    ...
                    <div class="opportunity-card animate-on-load-delay-1"
                        ...
                        <div style="padding: 35px 30px;">
                            ...
                            <div style="display: flex; flex-wrap: wrap; gap: 10px; margin-bottom: 30px;">
                                ...
                                <span
                                    style="background: rgba(145,116,110,0.1); color: #91746E; padding: 6px 15px; border-radius: 20px; font-size: 13px; font-weight: 600; transition: all 0.3s ease;">Graphic
                                    Design</span>
                                <span
                                    style="background: rgba(128,143,189,0.1); color: #373358; padding: 6px 15px; border-radius: 20px; font-size: 13px; font-weight: 600; transition: all 0.3s ease;">Video
                                    Editing</span>
                            </div>
                            <a href="#application2" style="text-decoration: none;">
                                <button
                                    style="background: linear-gradient(90deg, #46DE48, #80E681); color: white; border: none; padding: 14px 30px; border-radius: 10px; font-size: 15px; font-weight: 700; cursor: pointer; width: 100%; display: flex; align-items: center; justify-content: center; gap: 10px; transition: all 0.3s ease;">
                                    <svg style="width: 18px; height: 18px; fill: white;" viewBox="0 0 24 24">
                                        <path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z" />
                                    </svg>
                                    Apply for this Role
                    ...
                    <div class="opportunity-card animate-on-load-delay-2"
                        ...
                        <div style="padding: 35px 30px;">
                            ...
                            <div style="display: flex; flex-wrap: wrap; gap: 10px; margin-bottom: 30px;">
                                <span
                                    style="background: rgba(145,116,110,0.1); color: #91746E; padding: 6px 15px; border-radius: 20px; font-size: 13px; font-weight: 600; transition: all 0.3s ease;">Active
                                    Listening</span>
                                <span
                                    style="background: rgba(128,143,189,0.1); color: #373358; padding: 6px 15px; border-radius: 20px; font-size: 13px; font-weight: 600; transition: all 0.3s ease;">Empathy</span>
                                <span
                                    style="background: rgba(220,206,193,0.1); color: #DCCEC1; padding: 6px 15px; border-radius: 20px; font-size: 13px; font-weight: 600; transition: all 0.3s ease;">Psychology
                                    Background</span>
                            </div>
                            <a href="#application2" style="text-decoration: none;">
                                <button
                                    style="background: #91746E; color: white; border: none; padding: 14px 30px; border-radius: 10px; font-size: 15px; font-weight: 700; cursor: pointer; width: 100%; display: flex; align-items: center; justify-content: center; gap: 10px; transition: all 0.3s ease;">
                                    <svg style="width: 18px; height: 18px; fill: white;" viewBox="0 0 24 24">
                                        <path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z" />
                                    </svg>
                                    Apply for this Role
                    ...
                    <div class="opportunity-card animate-on-load-delay-3"
                        style="background: white; border-radius: 25px; overflow: hidden; box-shadow: 0 15px 40px rgba(0,0,0,0.08); position: relative; border-top: 5px solid #373358;">
                        <div style="padding: 35px 30px;">
                            <div style="display: flex; align-items: center; gap: 15px; margin-bottom: 25px;">
                                <div class="opportunity-icon rotate-in"
                                    style="background: rgba(128,143,189,0.1); color: #373358; width: 60px; height: 60px; border-radius: 12px; display: flex; align-items: center; justify-content: center;">
                                ...
                                <div>
                                    <div style="color: #373358; font-size: 14px; font-weight: 700;">REMOTE • FLEXIBLE</div>
                            ...
                            <div style="display: flex; flex-wrap: wrap; gap: 10px; margin-bottom: 30px;">
                                <span
                                    style="background: rgba(128,143,189,0.1); color: #373358; padding: 6px 15px; border-radius: 20px; font-size: 13px; font-weight: 600; transition: all 0.3s ease;">Excel</span>
                                <span
                                ...
                                <span
                                    style="background: rgba(221,49,52,0.1); color: #DD3134; padding: 6px 15px; border-radius: 20px; font-size: 13px; font-weight: 600; transition: all 0.3s ease;">Reporting</span>
                            </div>
                            <a href="#application2" style="text-decoration: none;">
                                <button
                                    style="background: #373358; color: white; border: none; padding: 14px 30px; border-radius: 10px; font-size: 15px; font-weight: 700; cursor: pointer; width: 100%; display: flex; align-items: center; justify-content: center; gap: 10px; transition: all 0.3s ease;">
                                    <svg style="width: 18px; height: 18px; fill: white;" viewBox="0 0 24 24">
                                        <path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z" />
                                    </svg>
                                    Apply for this Role
            ...
            <div class="volunteer-section animate-on-load"
                ...
                <div style="position: relative; z-index: 2;">
                    <div style="text-align: center; margin-bottom: 40px;">
                        ...
                        <p class="animate-on-load-delay-1"
                            style="font-size: 18px; color: #DCCEC1; max-width: 700px; margin: 0 auto; line-height: 1.6;">
                    ...
                    <div class="volunteer-grid stagger-children"
                        ...
                        <div
                            style="background: rgba(255,255,255,0.1); border-radius: 20px; padding: 30px; backdrop-filter: blur(10px); border: 1px solid rgba(255,255,255,0.2); transition: all 0.4s ease;">
                        ...
                        <div
                            ...
                            <div style="display: flex; align-items: center; gap: 15px; margin-bottom: 15px;">
                                <div
                                    style="background: rgba(221,49,52,0.2); min-width: 45px; height: 45px; border-radius: 10px; display: flex; align-items: center; justify-content: center; transition: all 0.3s ease;">
                        ...
                        <div
                            ...
                            <div style="display: flex; align-items: center; gap: 15px; margin-bottom: 15px;">
                                <div
                                    style="background: rgba(128,143,189,0.2); min-width: 45px; height: 45px; border-radius: 10px; display: flex; align-items: center; justify-content: center; transition: all 0.3s ease;">
                        ...
                        <div
                            ...
                            <div style="display: flex; align-items: center; gap: 15px; margin-bottom: 15px;">
                                <div
                                    style="background: rgba(145,116,110,0.2); min-width: 45px; height: 45px; border-radius: 10px; display: flex; align-items: center; justify-content: center; transition: all 0.3s ease;">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 60px; align-items: start;">
                        ...
                        <div class="slide-in-left"
                            ...
                            <form style="display: grid; gap: 25px;">
                                ...
                                <button type="submit"
                                    style="background: #DD3134; color: white; border: none; padding: 18px; border-radius: 12px; font-size: 16px; font-weight: 700; cursor: pointer; width: 100%; box-shadow: 0 10px 25px rgba(221,49,52,0.3); display: flex; align-items: center; justify-content: center; gap: 12px; transition: all 0.3s ease; animation: fadeInUp 0.5s ease-out 0.9s both;">
                                    <svg style="width: 20px; height: 20px; fill: white;" viewBox="0 0 24 24">
                        ...
                        <div>
                            ...
                            <div class="sidebar-card slide-in-right"
                                style="background: white; border-radius: 25px; padding: 40px; margin-bottom: 30px; box-shadow: 0 15px 40px rgba(0,0,0,0.08); transition: all 0.4s ease;">
                                <div style="display: flex; align-items: center; gap: 15px; margin-bottom: 25px;">
                            ...
                            <div class="sidebar-card slide-in-right"
                                style="background: linear-gradient(135deg, #363558, #434961); border-radius: 25px; padding: 40px; color: white; transition: all 0.4s ease; animation-delay: 0.3s;">
            ...
            <div style="margin-bottom: 80px;">
                ...
                <div style="max-width: 900px; margin: 0 auto;">
                    <div class="faq-item animate-on-load"
                        style="background: white; border-radius: 20px; padding: 30px; margin-bottom: 20px; box-shadow: 0 5px 20px rgba(0,0,0,0.05); transition: all 0.4s ease; animation-delay: 0.1s;">
                        <div class="faq-question"
                            ...
                            <h3 style="font-size: 18px; color: #363558; margin: 0; font-weight: 700;">How much time do I
                                need to commit?</h3>
                            <svg class="faq-icon"
                                style="width: 20px; height: 20px; fill: #DD3134; transition: transform 0.4s cubic-bezier(0.68, -0.55, 0.265, 1.55);"
                                viewBox="0 0 24 24">
                    ...
                    <div class="faq-item animate-on-load-delay-1"
                        style="background: white; border-radius: 20px; padding: 30px; margin-bottom: 20px; box-shadow: 0 5px 20px rgba(0,0,0,0.05); transition: all 0.4s ease;">
                        <div class="faq-question"
                            style="display: flex; justify-content: space-between; align-items: center; cursor: pointer; transition: all 0.3s ease;">
                    ...
                    <div class="faq-item animate-on-load-delay-3"
                        style="background: white; border-radius: 20px; padding: 30px; box-shadow: 0 5px 20px rgba(0,0,0,0.05); transition: all 0.4s ease;">
                        <div class="faq-question"
                            style="display: flex; justify-content: space-between; align-items: center; cursor: pointer; transition: all 0.3s ease;">
            ...
            <!-- Final CTA -->
            <div class="animate-on-load"
                style="background: #DD3134; border-radius: 30px; padding: 70px; text-align: center; color: white; transition: all 0.4s ease;">
                <h2 class="animate-on-load"
                ...
                <a href="#application2" style="text-decoration: none;">
                    <div style="display: flex; gap: 20px; justify-content: center; flex-wrap: wrap;">
                        <button class="animate-on-load-delay-2"
                            ...
                            <svg style="width: 20px; height: 20px; fill: #DD3134; transition: transform 0.3s ease;"
                                viewBox="0 0 24 24">
                                <path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z" />
                            </svg>
                            Apply Now
