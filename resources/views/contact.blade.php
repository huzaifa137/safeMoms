...
<div style="font-family: 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; background: linear-gradient(135deg, #E7E9ED 0%, #E7E9ED 100%); margin-top: 8em; padding-bottom: 0; overflow: hidden;">
    ...
    <section class="contact-section" style="padding: 120px 10% 80px 10%; text-align: center;">
        <div class="contact-hero-badge" style="display: inline-block; padding: 10px 30px; background: linear-gradient(135deg, #363558 0%, #2d2a4a 100%); color: white; border-radius: 30px; font-size: 14px; font-weight: 800; margin-bottom: 30px; letter-spacing: 1px; box-shadow: 0 10px 30px rgba(54, 53, 88, 0.3);">
            CONTACT US
        </div>
        <h1 class="contact-hero-title" style="font-size: 56px; font-weight: 900; color: #363558; margin-bottom: 25px; line-height: 1.1;">
            Get in <span style="color: #DD3134;">Touch</span> With Us
        </h1>
        ...
        <div class="contact-hero-divider" style="height: 5px; width: 150px; background: linear-gradient(to right, #DD3134, #46DE48); margin: 0 auto; border-radius: 2px;"></div>
    </section>
        ...
        <div style="display: flex; gap: 60px; align-items: stretch;">
            ...
            <div style="flex: 1; display: flex; flex-direction: column; gap: 25px;">
                ...
                <div style="background: white; border-radius: 25px; padding: 40px; box-shadow: 0 20px 50px rgba(128, 143, 189, 0.15); transition: all 0.4s ease; border-left: 6px solid #DD3134;"
                    ...
                    <div style="display: flex; align-items: center; gap: 20px; margin-bottom: 25px;">
                        <div style="width: 60px; height: 60px; background: linear-gradient(135deg, #DD3134, #ff6b6b); border-radius: 15px; display: flex; align-items: center; justify-content: center; color: white; font-size: 24px;">
                ...
                <div style="background: white; border-radius: 25px; padding: 40px; box-shadow: 0 20px 50px rgba(128, 143, 189, 0.15); transition: all 0.4s ease; border-left: 6px solid #46DE48;"
                    ...
                    onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 20px 50px rgba(128, 143, 189, 0.15)'">
                    <div style="display: flex; align-items: center; gap: 20px; margin-bottom: 25px;">
                        <div style="width: 60px; height: 60px; background: linear-gradient(135deg, #46DE48, #6bff8f); border-radius: 15px; display: flex; align-items: center; justify-content: center; color: white; font-size: 24px;">
                ...
                <div style="background: white; border-radius: 25px; padding: 40px; box-shadow: 0 20px 50px rgba(128, 143, 189, 0.15); transition: all 0.4s ease; border-left: 6px solid #373358;"
                    ...
                    onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 20px 50px rgba(128, 143, 189, 0.15)'">
                    <div style="display: flex; align-items: center; gap: 20px; margin-bottom: 25px;">
                        <div style="width: 60px; height: 60px; background: linear-gradient(135deg, #373358, #a6b5e0); border-radius: 15px; display: flex; align-items: center; justify-content: center; color: white; font-size: 24px;">
                    ...
                    <div style="font-size: 16px; color: #91746E; line-height: 1.6; padding-left: 10px;">
                        General: <span style="color: #363558; font-weight: 800;">hello@safeMom.org</span><br>
                        Partnerships: <span style="color: #363558; font-weight: 800;">partners@safeMom.org</span>
                    </div>
                </div>
                ...
                <div style="background: white; border-radius: 25px; padding: 40px; box-shadow: 0 20px 50px rgba(128, 143, 189, 0.15); transition: all 0.4s ease; border-left: 6px solid #91746E;"
                    ...
                    <div style="font-weight: 900; color: #363558; margin-bottom: 25px; font-size: 18px; display: flex; align-items: center; gap: 15px;">
                        <div style="width: 50px; height: 50px; background: linear-gradient(135deg, #91746E, #b99f97); border-radius: 12px; display: flex; align-items: center; justify-content: center; color: white; font-size: 22px;">
    ...
    <!-- Emergency Banner -->
    <section class="emergency-banner" style="background: linear-gradient(90deg, #DD3134 0%, #ff6b6b 100%); padding: 25px 10%; display: flex; justify-content: center; align-items: center; color: white; gap: 20px;">
