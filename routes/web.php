...
Route::view('Research-and-Publications', 'Research-and-Publications');
Route::view('partner-with-smn', 'partner-with-smn');
Route::view('become-a-navigator', 'become-a-navigator');
Route::view('become-a-volunteer', 'become-a-volunteer');
